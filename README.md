...
- **Automated SQLite Persistence:**  backend pipeline that automatically caches sentence vectors and UMAP coordinates upon first launch, eliminating redundant deep-learning computation.
